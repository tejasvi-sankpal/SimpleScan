...
- (void)initNavigationBar
{
    ...
    if(self.navigationController!=nil){
        ...
        [_navigationBar setBarTintColor:[UIColor colorWithRed:(float)0/255 green:(float)128/255 blue:(float)128/255 alpha:1.0]];
        _navigationBar.titleTextAttributes = [NSDictionary dictionaryWithObject:[UIColor colorWithRed:(float)255/255 green:(float)255/255 blue:(float)255/255 alpha:1.0] forKey:NSForegroundColorAttributeName];
